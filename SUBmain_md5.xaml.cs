...
namespace 帮我查
{
    ...
    /// </summary>
    public sealed partial class SUBmain_md5 : Page
    {
        ...
        {
            _htmltianqiV.Source = new Uri("http://news.hatohalo.com:801/bwc_zz_md5.aspx?md5=" + _sip.Text.Trim());
        }
        ...
        private void citie_Click(object sender, RoutedEventArgs e)
        {
            ...
            Pin("ms-appx:///Assets/Square150x150Logo.scale-240.png", this.GetType().Name, "帮我查-彩虹表");
        }
    }
}
