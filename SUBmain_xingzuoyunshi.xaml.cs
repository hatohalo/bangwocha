...
namespace 帮我查
{
    ...
    /// </summary>
    public sealed partial class SUBmain_xingzuoyunshi : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public SUBmain_xingzuoyunshi()
        {
        ...
        private void AddAppBarButtonZ_Click(object sender, RoutedEventArgs e)
        {
            //处理浏览器
            _htmltianqiV.Source = new Uri("http://tools.2345.com/m/naonao/");
        }

        private void AddAppBarButtonY_Click(object sender, RoutedEventArgs e)
        {
            //处理浏览器
            _htmltianqiV.Source = new Uri("http://tools.2345.com/m/susan/");
        }
        ...
        private void citie_Click(object sender, RoutedEventArgs e)
        {
            ...
            Pin("ms-appx:///Assets/Square150x150Logo.scale-240.png", this.GetType().Name, "帮我查-星座");
        }
    }
}
