...
namespace 帮我查
{
    ...
    public sealed partial class App : Application
    {
        ...
        protected override void OnActivated(IActivatedEventArgs args)
        {
            ...
            {
                PublicS.commandArgs = args as Windows.ApplicationModel.Activation.VoiceCommandActivatedEventArgs;
                BeginRunMainPage(args);

            }
            if (args.Kind == Windows.ApplicationModel.Activation.ActivationKind.PickFileContinuation)
            {
                PublicS.commandArgs_PickFile = args as Windows.ApplicationModel.Activation.FileOpenPickerContinuationEventArgs;
                BeginRunMainPage(args);
            }
        ...
        /// </summary>
        /// <param name="e"></param>
        private async void BeginRunMainPage(IActivatedEventArgs e)
        {
#if DEBUG
