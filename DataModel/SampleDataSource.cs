...
namespace 帮我查.Data
{
    ...
    {
        public SampleDataItem(String uniqueId, String title, String subtitle, String imagePath, String description, String content,dianji djdelegate)
        {
        ...
        public dianji djDelegate { get;  set; }
            ...
            foreach (JsonValue groupValue in jsonArray)
            {
                ...
                foreach (JsonValue itemValue in groupObject["Items"].GetArray())
                {
                    ...
                    group.Items.Add(new SampleDataItem(itemObject["UniqueId"].GetString(),
                                                       ...
                                                       itemObject["Content"].GetString(), null));
                }
