...
namespace 帮我查
{
    ...
    /// </summary>
    public sealed partial class SUBmain_rili : Page
    {
        ...
        private void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            if (e.NavigationParameter.GetType().Equals(typeof(string)))
            {
                ...
                //处理浏览器
                _htmltianqiV.Source = new Uri("http://tools.2345.com/m/rili.htm");
        ...
        private async void _htmltianqiV_DOMContentLoaded(WebView sender, WebViewDOMContentLoadedEventArgs args)
        {
            try
            {
                ...
                List<string> arguments = new List<string> { "var ReSet_yhb_haha_num = 0; var ReSet_yhb_haha_interval = null;  function ReSet_yhb_haha(){ if(ReSet_yhb_haha_num > 20){clearInterval(ReSet_yhb_haha_interval)};   $(\"header\").hide();   $(\".mod-a.clearfix\").hide(); $(\".navfixed\").hide();$(\"footer\").hide();  $(\"#share_button\").hide();  $(\".quickLnk\").remove();   $(\".ulLinksB\").hide();    $(\".almanac a[target='_blank']\").attr(\"target\",\"_top\");  return 'ok';}    function ReSet_yhb_haha_dingshi(){window.setInterval(ReSet_yhb_haha, 100); }" };
        ...
        private void AddAppBarButton3_Click(object sender, RoutedEventArgs e)
        {
            _htmltianqiV.Source = new Uri("http://tools.2345.com/m/jrhl.htm");
        }
        ...
        private void citie_Click(object sender, RoutedEventArgs e)
        {
            ...
            Pin("ms-appx:///Assets/Square150x150Logo.scale-240.png", this.GetType().Name, "帮我查-日历");
        }
    }
}
