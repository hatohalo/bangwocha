...
namespace 帮我查
{
    ...
    /// </summary>
    public sealed partial class SUBmain_gupiao : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public SUBmain_gupiao()
        {
        ...
        private void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            if (e.NavigationParameter.GetType().Equals(typeof(string)))
            {
                ...
                //处理浏览器
                _htmltianqiV.Source = new Uri("http://s.m.sohu.com/t/ph.html");
            ...
            if (e.NavigationParameter.GetType().Equals(typeof(VoiceCommandActivatedEventArgs)))
            {
                ...
                _htmltianqiV.Source = new Uri("http://s.m.sohu.com/t/search.html?paras=" + gupiao);
        ...
        private async void _htmltianqiV_DOMContentLoaded(WebView sender, WebViewDOMContentLoadedEventArgs args)
        {
            try
            {
                ...
                List<string> arguments = new List<string> { "var ReSet_yhb_haha_num = 0; var ReSet_yhb_haha_interval = null;  function ReSet_yhb_haha(){ if(ReSet_yhb_haha_num > 20){clearInterval(ReSet_yhb_haha_interval)};  BWCJQ_haha(\".h1\").html(\"<span>股票</span>\");   BWCJQ_haha(\".site\").hide(); BWCJQ_haha(\"div[id^='beans_']\").hide(); BWCJQ_haha(\".top_home\").hide();BWCJQ_haha(\".hd_tips2\").hide(); BWCJQ_haha(\"[action='login']\").hide(); BWCJQ_haha(\"[target='_blank']\").attr(\"target\",\"_top\"); BWCJQ_haha(\"#iconTip\").remove();  return 'ok';}    function ReSet_yhb_haha_dingshi(){window.setInterval(ReSet_yhb_haha, 100); }" };
        ...
        private void citie_Click(object sender, RoutedEventArgs e)
        {
            ...
            Pin("ms-appx:///Assets/Square150x150Logo.scale-240.png", this.GetType().Name, "帮我查-股票");
        }
    }
}
