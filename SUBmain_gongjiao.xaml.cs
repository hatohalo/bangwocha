...
namespace 帮我查
{
    ...
    /// </summary>
    public sealed partial class SUBmain_gongjiao : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public SUBmain_gongjiao()
        {
        ...
        private async void _htmltianqiV_DOMContentLoaded(WebView sender, WebViewDOMContentLoadedEventArgs args)
        {
            try
            {
                ...
                List<string> arguments = new List<string> { "var ReSet_yhb_haha_num = 0; var ReSet_yhb_haha_interval = null; function ReSet_yhb_haha(){ if(ReSet_yhb_haha_num > 20){clearInterval(ReSet_yhb_haha_interval)};   $(\"#BAIDU_DUP_fp_wrapper\").hide();    $(\".topAdv\").hide();  $(\"#auto973adid1016\").hide();$(\".mainNav\").hide();   $(\".location\").hide();    $(\".relatedLink\").hide(); $(\".BackMenuTip\").hide(); $(\".m_ad\").hide(); $(\".center\").hide();$(\".remark\").hide();$(\".top_line\").hide();  $(\"footer\").hide();    $(\"#big_ad\").remove(); $(\".text_info\").hide();  $(\".subNav a\").remove();  $(\"iframe\").remove(); $(\":contains('closeBtn')\").remove(); $(\".tqGotoTop\").remove();  $(\"li:contains('周边美食')\").remove(); $(\"li:contains('周边生活')\").remove();   return 'ok';} function ReSet_yhb_haha_dingshi(){window.setInterval(ReSet_yhb_haha, 100); }" };
        ...
        private void citie_Click(object sender, RoutedEventArgs e)
        {
            ...
            Pin("ms-appx:///Assets/Square150x150Logo.scale-240.png", this.GetType().Name, "帮我查-公交");
        }
