...
namespace 帮我查
{
    ...
    /// </summary>
    public sealed partial class SUBmain_danweihuansuan : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public SUBmain_danweihuansuan()
        {
        ...
        private void bwc_dwhs_Click(object sender, RoutedEventArgs e)
        {
            AppBarButton abbb = (AppBarButton)sender;
            string n = abbb.Name;
            _htmltianqiV.Navigate(new Uri("ms-appx-web:///DataModel/dwhs/" + n + ".html"));
        }
        ...
        private void citie_Click(object sender, RoutedEventArgs e)
        {
            ...
            Pin("ms-appx:///Assets/Square150x150Logo.scale-240.png", this.GetType().Name, "帮我查-换算");
        }
    }
}
