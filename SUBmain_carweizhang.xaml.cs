...
namespace 帮我查
{
    ...
    /// </summary>
    public sealed partial class SUBmain_carweizhang : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public SUBmain_carweizhang()
        {
        ...
        private void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            if (e.NavigationParameter.GetType().Equals(typeof(string)))
            {
                ...
                //处理浏览器
                _htmltianqiV.Source = new Uri("http://dp.sina.cn/dpool/tools/clwg/index.php");
        ...
        private async void _htmltianqiV_DOMContentLoaded(WebView sender, WebViewDOMContentLoadedEventArgs args)
        {
            try
            {
                ...
                List<string> arguments = new List<string> { "var ReSet_yhb_haha_num = 0; var ReSet_yhb_haha_interval = null;  function ReSet_yhb_haha(){ if(ReSet_yhb_haha_num > 20){clearInterval(ReSet_yhb_haha_interval)};   BWCJQ_haha(\"header\").hide(); BWCJQ_haha(\".rtop\").hide(); BWCJQ_haha(\"footer\").hide();  BWCJQ_haha(\"div:contains('新浪')\").hide(); BWCJQ_haha(\"p:contains('其他服务')\").hide(); BWCJQ_haha(\".options.fl-book\").hide();    return 'ok';}    function ReSet_yhb_haha_dingshi(){window.setInterval(ReSet_yhb_haha, 100); }" };
        ...
        private void citie_Click(object sender, RoutedEventArgs e)
        {
            ...
            Pin("ms-appx:///Assets/Square150x150Logo.scale-240.png", this.GetType().Name, "帮我查-违章");
        }
    }
}
