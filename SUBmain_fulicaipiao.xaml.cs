...
namespace 帮我查
{
    ...
    /// </summary>
    public sealed partial class SUBmain_fulicaipiao : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public SUBmain_fulicaipiao()
        {
        ...
        private async void _htmltianqiV_DOMContentLoaded(WebView sender, WebViewDOMContentLoadedEventArgs args)
        {
            try
            {
                ...
                List<string> arguments = new List<string> { "var ReSet_yhb_haha_num = 0; var ReSet_yhb_haha_interval = null;  function ReSet_yhb_haha(){ if(ReSet_yhb_haha_num > 20){clearInterval(ReSet_yhb_haha_interval)}; BWCJQ_haha(\"body\").css(\"font-size\",\"15px\");BWCJQ_haha(\"h1\").css(\"font-size\",\"20px\");   BWCJQ_haha(\".logo-top\").hide(); BWCJQ_haha(\".wap-logo\").hide(); BWCJQ_haha(\".wap-nav\").hide();BWCJQ_haha(\".wap-banner\").hide();BWCJQ_haha(\".wap-banner\").hide();  BWCJQ_haha(\"h1:last\").hide(); BWCJQ_haha(\".wap-footer\").hide(); BWCJQ_haha(\"[href$='bySelf']\").hide();  BWCJQ_haha(\"[href$='bySelf']\").removeAttr(\"href\");  BWCJQ_haha(\"[href$='byDirect']\").hide();  BWCJQ_haha(\"[href$='byDirect']\").removeAttr(\"href\");  BWCJQ_haha(\"[href$='lotteryCenter']\").hide();  BWCJQ_haha(\"a[href^='/w3g/leaveOut/']\").hide();  BWCJQ_haha(\"a:contains('购买')\").hide(); return 'ok';}    function ReSet_yhb_haha_dingshi(){window.setInterval(ReSet_yhb_haha, 100); }" };
        ...
        private void citie_Click(object sender, RoutedEventArgs e)
        {
            ...
            Pin("ms-appx:///Assets/Square150x150Logo.scale-240.png", this.GetType().Name, "帮我查-彩票");
        }
    }
}
