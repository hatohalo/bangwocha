...
namespace 帮我查
{
    ...
    /// </summary>
    public sealed partial class SUBmain_jiemeng : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public SUBmain_jiemeng()
        {
        ...
        private void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            if (e.NavigationParameter.GetType().Equals(typeof(string)))
            {
                ...
                //处理浏览器
                _htmltianqiV.Source = new Uri("http://tools.2345.com/m/zhgjm.htm");
            ...
            if (e.NavigationParameter.GetType().Equals(typeof(VoiceCommandActivatedEventArgs)))
            {
                ...
                string jiemeng = textSpoken.Replace("梦见", "").Replace("了", "").Replace("梦到", "").Replace("了", "").Replace("怎么回事", "").Replace("意味着什么", "").Replace("怎么解", "").Replace("什么意思", "").Trim();
                _htmltianqiV.Source = new Uri("http://tools.2345.com/m/zhgjm/search.php?w=" + jiemeng);
        ...
        private async void _htmltianqiV_DOMContentLoaded(WebView sender, WebViewDOMContentLoadedEventArgs args)
        {
            try
            {
                ...
                List<string> arguments = new List<string> { "var ReSet_yhb_haha_num = 0; var ReSet_yhb_haha_interval = null;  function ReSet_yhb_haha(){ if(ReSet_yhb_haha_num > 20){clearInterval(ReSet_yhb_haha_interval)};   $(\".logo\").hide(); $(\".mod-a.clearfix\").hide(); $(\".navfixed\").hide();$(\"footer\").hide();  $(\"#share_button\").hide();  $(\"#zghjm_app-bottom\").remove();   return 'ok';}    function ReSet_yhb_haha_dingshi(){window.setInterval(ReSet_yhb_haha, 100); }" };
        ...
        private void citie_Click(object sender, RoutedEventArgs e)
        {
            ...
            Pin("ms-appx:///Assets/Square150x150Logo.scale-240.png", this.GetType().Name, "帮我查-解梦");
        }
    }
}
