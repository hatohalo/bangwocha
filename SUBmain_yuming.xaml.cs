...
namespace 帮我查
{
    ...
    /// </summary>
    public sealed partial class SUBmain_yuming : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public SUBmain_yuming()
        {
        ...
        private void _htmltianqiV_DOMContentLoaded(WebView sender, WebViewDOMContentLoadedEventArgs args)
        {
            try
            {
                ...
                //List<string> arguments = new List<string> { "function ReSet_yhb_haha(){ $(\".logo\").hide(); $(\".mod-a.clearfix\").hide(); $(\".navfixed\").hide();$(\"footer\").hide();  $(\"#share_button\").hide();  $(\"#zghjm_app-bottom\").remove();   return 'ok';}" };
                //await _htmltianqiV.InvokeScriptAsync("eval", arguments);

                // 调用刚刚注册的脚本
                //string result = await _htmltianqiV.InvokeScriptAsync("ReSet_yhb_haha", null);
        ...
        {
            _htmltianqiV.Source = new Uri("http://news.hatohalo.com:801/bwc_zz_yuming.aspx?yuming=" + _sip.Text.Trim());
        }
        ...
        private void citie_Click(object sender, RoutedEventArgs e)
        {
            ...
            Pin("ms-appx:///Assets/Square150x150Logo.scale-240.png", this.GetType().Name, "帮我查-域名");
        }
    }
}
