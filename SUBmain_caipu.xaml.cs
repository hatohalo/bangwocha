...
namespace 帮我查
{
    ...
    /// </summary>
    public sealed partial class SUBmain_caipu : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public SUBmain_caipu()
        {
        ...
        private void NavigationHelper_LoadState(object sender, LoadStateEventArgs e)
        {
            ...
            if (e.NavigationParameter.GetType().Equals(typeof(string)))
            {
                ...
                //处理浏览器
                _htmltianqiV.Source = new Uri("http://tools.2345.com/m/meishi/");
            }
            if (e.NavigationParameter.GetType().Equals(typeof(VoiceCommandActivatedEventArgs)))
            {
                ...
                string caiming = textSpoken.Replace("的做法", "").Replace("做法", "").Replace("的菜谱", "").Replace("菜谱", "").Replace("怎么做", "").Trim();
                _htmltianqiV.Source = new Uri("http://tools.2345.com/m/meishi/s.php?keyword=" + caiming);
        ...
        private void citie_Click(object sender, RoutedEventArgs e)
        {
            ...
            Pin("ms-appx:///Assets/Square150x150Logo.scale-240.png", this.GetType().Name, "帮我查-菜谱");
        }
