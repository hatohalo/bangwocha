...
namespace 帮我查
{
    ...
    /// </summary>
    public sealed partial class SUBmain_ipdizhi : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public SUBmain_ipdizhi()
        {
        ...
        {
            _htmltianqiV.Source = new Uri("http://news.hatohalo.com:801/bwc_zz_ip.aspx?ip=" + _sip.Text.Trim());
        }
        ...
        private void citie_Click(object sender, RoutedEventArgs e)
        {
            ...
            Pin("ms-appx:///Assets/Square150x150Logo.scale-240.png", this.GetType().Name, "帮我查-IP地址");
        }
    }
}
